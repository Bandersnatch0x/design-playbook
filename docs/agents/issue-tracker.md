...
- **Wayfinder dx-feedback-triage (2026-07-19):** `.scratch/dx-feedback-triage/` — map `map.md`; 外部 DX 反馈 6 项逐条核查 + 5 张决策票。**全 resolved + implement attached (preview control bar button flows, draft, direct-confirm, S10-S12 tests as 02 visibility polish)。Effort closed 2026-07-20.**
