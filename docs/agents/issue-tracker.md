...
- **Wayfinder dx-feedback-triage (2026-07-19):** `.scratch/dx-feedback-triage/` — map `map.md`; 外部 DX 反馈 6 项逐条核查（裁决表在 map Notes）+ 5 张决策票（README 冷启动 / 运行可见性 / 组合优先级 / showcase 扩量 / 契约版本 defer），全部在 frontier。
