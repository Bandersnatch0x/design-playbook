...
| Preview decision transaction | active (2026-07-26; tickets `01`-`03` resolved; frontier `04`) |
...
1. Preview decision transaction：`.scratch/preview-decision-transaction/`；`01`-`03` resolved，frontier `04-gate-compatibility-and-release`（ready-for-agent）
