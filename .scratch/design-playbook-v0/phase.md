...
| Preview decision transaction | active (2026-07-26; tickets `01`-`02` resolved; frontier `03`) |
...
1. Preview decision transaction：`.scratch/preview-decision-transaction/`；`01`-`02` resolved，frontier `03-locking-and-structured-errors`（ready-for-agent）
