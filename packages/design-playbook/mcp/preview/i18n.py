...
_STRINGS: dict[str, dict[str, str]] = {
    ZH: {
        ...
        "criteria_count": "准则 {checked}/{total}",
        "criteria_empty": "无 spec 判据来源",
        "criteria_toggle_title": "收起/展开验收准则面板",
        "theme_toggle": "切换明暗主题",
    ...
    EN: {
        ...
        "criteria_title": "Acceptance Criteria (Spec Matrix)",
        "criteria_count": "Criteria {checked}/{total}",
        "criteria_empty": "No spec criteria source",
        "criteria_toggle_title": "Toggle acceptance criteria panel",
