...
_STRINGS: dict[str, dict[str, str]] = {
    ZH: {
        ...
        "drawer_empty_desc": "用点选工具放置 Pin，按 B 框选区域，或按 D 圈画问题；也可在下方写整体意见",
        "collapse": "收起",
        "pin_toggle": "点选批注",
        "pin_toggle_desc": "开启后点击页面元素添加批注锚点；再点一次或按 Esc 退出",
        "duplicate_anchor": "该元素已是批注 {n}，未重复添加",
        "onboard_title": "标注速览（仅出现一次）",
        "onboard_pick": "点「批注」后点选元素，按 B 拖拽框选，或按 R 临时测距",
    ...
    EN: {
        ...
        "drawer_empty_desc": "Use pin mode to place a note, press B for a box, or D to draw; you can also write overall feedback below",
        "collapse": "Collapse",
        ...
        "onboard_pick": "Click Annotate to pick elements, press B to draw a box, or press R to measure spacing",
